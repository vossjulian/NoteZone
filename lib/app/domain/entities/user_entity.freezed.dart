...
abstract class $UserEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, String email, bool isAuthenticated});
}
...
class _$_UserEntity implements _UserEntity {
  _$_UserEntity({this.uid = "", this.email = "", this.isAuthenticated = false});
  ...
  @override
  String toString() {
    return 'UserEntity(uid: $uid, email: $email, isAuthenticated: $isAuthenticated)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, uid, email, isAuthenticated);
...
abstract class _UserEntity implements UserEntity {
  factory _UserEntity(
      {final String uid,
      final String email,
      final bool isAuthenticated}) = _$_UserEntity;
